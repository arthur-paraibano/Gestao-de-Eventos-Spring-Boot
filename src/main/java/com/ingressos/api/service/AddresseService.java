...
import com.ingressos.api.repository.AddresseRepository;
...
public class AddresseService {
    @Autowired
    private AddresseRepository repository;
    @Autowired
    private InternationalizationUtil messageIniernat;

    @Transactional(readOnly = true)
    public List<AddresseModel> findAll() {
        return repository.findAll();
    }

    @Transactional(readOnly = true)
    public AddresseModel findById(GeneralDto dto) {
