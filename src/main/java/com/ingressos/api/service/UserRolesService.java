...
import com.ingressos.api.model.UserRolesModel;
import com.ingressos.api.repository.UserRolesRepository;
...
public class UserRolesService {
    ...
    public List<UserRolesModel> findAll() {
        return repository.findAll();
    }

    @Transactional(readOnly = true)
    public UserRolesModel findById(GeneralDto dto) {
        ...
        return repository.findById(dto.id())
                .orElseThrow(() -> new IncorrectParameterException(
                        messageIniernat.getMessage("descriptions.userroles.notfound")));
    }
}
